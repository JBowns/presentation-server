...
class PresentationServer {
    ...
    constructor(presentations, userDefinedConfig) {
        ...
        this.presentationContainer = this.loadContainer(path.join(root, '/templates/presentationContainer.mustache'));
        this.configurationContainer = this.loadContainer(path.join(root, '/templates/configurationContainer.mustache'));
        ...
        this.themes = []
        .concat('themes' in this.staticConfig ? this.loadCSSResources(this.staticConfig.themes) : [])
        .concat('themes' in userDefinedConfig ? this.loadCSSResources(userDefinedConfig.themes) : [])
        .filter((value, index, self) => { 
            return self.indexOf(value) === index;
        });

        this.styles = []
        .concat('styles' in this.staticConfig ? this.loadCSSResources(this.staticConfig.styles) : [])
        .concat('styles' in userDefinedConfig ? this.loadCSSResources(userDefinedConfig.styles) : [])
        .filter((value, index, self) => { 
            return self.indexOf(value) === index;
        });
