...
class PresentationServer {
    ...
    constructor(presentations, config) {
        ...
        this.config = Object.assign({
            resources: __dirname + '/../..',
            lib: __dirname + '/../../reveal.js/lib',
            themes: __dirname + '/../../reveal.js/css/theme',
            styles: __dirname + '/../../highlight.js/src/styles'
        }, config);
    ...
    configureEndpoints() {
        ...
        Object.keys(this.config).map(resource => {
            this.app.use('/' + resource, express.static(this.config[resource]));
        });
